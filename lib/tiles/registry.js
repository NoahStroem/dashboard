...
window.TILES = [
  ...
  { id: 'lift', name: 'Lift', file: 'tiles/lift.html', size: 's', page: true },
  { id: 'train', name: 'Train', file: 'tiles/train.html', size: 'l', page: true },
  { id: 'stack', name: 'Stack', file: 'tiles/stack.html', size: 'l', page: true },
  { id: 'radar', name: 'Radar', file: 'tiles/radar.html', size: 'l', page: true },
]
